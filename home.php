...
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-w76AqPfDkMBDXo30jS1Sgez6pr3x5MlQ1ZAGC+nuZB+EYdgRZgiwxhTBTkF7CXvN" crossorigin="anonymous" width="600px" height="450px" style="border:0;" allowfullscreen="" loading="lazy"></script>

    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCkUOdZ5y7hMm0yrcCQoCvLwzdM6M8s5qk&callback=initMap" async defer></script>
    <br><br>
    <form onsubmit="updateMap(); return false;">
    ...
    <script>
      ...
      // Define a function to update the map based on the latitude and longitude input
      function updateMap() {
        // Get the latitude and longitude input values
        var latitude = parseFloat(document.getElementById('latitude').value);
        var longitude = parseFloat(document.getElementById('longitude').value);

        // Check that the latitude and longitude values are valid
